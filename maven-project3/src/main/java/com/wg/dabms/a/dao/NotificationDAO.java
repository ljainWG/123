...
public class NotificationDAO extends GenericDAO<Notification> {
    ...
    public Notification getNotificationById(String uuid) {
        String query = "SELECT * FROM notifications WHERE uuid = ?";
    ...
    public boolean createNotification(Notification notification) {
        String query = "INSERT INTO notifications (uuid, generator_id, receiver_id, title, description, generated_at, updated_at) VALUES (?, ?, ?, ?, ?, ?, ?)";
    ...
    public boolean updateNotification(Notification notification) {
        String query = "UPDATE notifications SET generator_id = ?, receiver_id = ?, title = ?, description = ?, generated_at = ?, updated_at = ? WHERE uuid = ?";
    ...
    public boolean deleteNotification(String uuid) {
        String query = "DELETE FROM notifications WHERE uuid = ?";
