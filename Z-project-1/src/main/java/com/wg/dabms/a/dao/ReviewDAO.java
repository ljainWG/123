...
public class ReviewDAO extends GenericDAO<Review> {
    ...
    public Review getReviewById(String uuid) {
        String query = "SELECT * FROM reviews WHERE uuid = ?";
    ...
    public boolean createReview(Review review) {
        String query = "INSERT INTO reviews (uuid, reviewee_id, reviewer_id, description, rating, is_reported, is_hidden, created_at, updated_at) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    public boolean updateReview(Review review) {
        String query = "UPDATE reviews SET reviewee_id = ?, reviewer_id = ?, description = ?, rating = ?, is_reported = ?, is_hidden = ?, created_at = ?, updated_at = ? WHERE uuid = ?";
    ...
    public boolean deleteReview(String uuid) {
        String query = "DELETE FROM reviews WHERE uuid = ?";
